...
const actions = {
  ...
  RUN_MODEL(context, {preDatasetMasterId, userId, name, modelName, parameter_json, isPublic, isUseGPU}) {
    return training
      .run(preDatasetMasterId, userId, name, modelName, parameter_json, isPublic, isUseGPU)
      .then((res) => {
        return res.data;
      });
  },
